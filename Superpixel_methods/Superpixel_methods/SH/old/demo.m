...
% % [compactness]: [0,1] (default 0) (Rémi)
% % N : number of points to start (Rémi)
...
tic; sh=SuperpixelHierarchyMex(I,E*0,0.5); toc
% get whatever you want
tic;
GetSuperpixels(sh,10000); 
toc;

%Script to select some scales
s_vect = 4000:-100:1; %[4000 3000 2000 1500 1000 500];
...
% compact superpixel
tic; N=1000; sh=SuperpixelHierarchyMex(I,E,0.9,0,N); toc
% get whatever you want
